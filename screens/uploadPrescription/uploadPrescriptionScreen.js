...
import { SafeAreaView, StatusBar, View, Text, Modal, FlatList, ScrollView, TouchableWithoutFeedback, StyleSheet, Image, Dimensions, TouchableOpacity } from "react-native";
...
const UploadPrescriptionScreen = ({ navigation }) => {
                        ...
                        <View style={styles.chooseFromCameraOrGalleryBoxStyle}>
                            <View style={styles.uploadPrescriptionModalHeaderStyle}>
                                ...
                                <MaterialIcons name="close" size={24} color={Colors.primaryColor}
                                    onPress={() => updateState({ uploadPrescriptionModal: false })}
                                />
                            </View>
                            <View style={styles.cameraAndGalleryButtonWrapStyle}>
                                <TouchableOpacity
                                    activeOpacity={0.6}
                                    onPress={() => {
                                        updateState({ uploadPrescriptionModal: false })
                                        pickImageFromCamera()
                                    }}
                                    style={{
            ...
            <View style={styles.continueButtonWrapStyle}>
                <TouchableOpacity
                    ...
                    onPress={() => prescriptionsList.length != 0
                        ?
                        navigation.push('PreviouslyBoughtItems')
                        :
                        null
                    }
    ...
    function uploadMorePrescriptionButton() {
        return (
            <TouchableOpacity
                activeOpacity={0.6}
                onPress={() => updateState({ uploadPrescriptionModal: true })}
